...
import { type $Else, type $Fn, type $Then, type IsBigintLiteral, testType } from '../index.js'
...
describe('IsBigintLiteral.$Fn', () => {
	it('is IsBigintLiteral as a type function', () => {
		testType.equal<$Fn.Apply<IsBigintLiteral.$Fn, 1n>, true>(true)
		testType.equal<$Fn.Apply<IsBigintLiteral.$Fn, bigint>, false>(true)
	})
})

it('resolves `IsBigintLiteral.$Default` the same as no options', () => {
	// `IsBigintLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsBigintLiteral<any, IsBigintLiteral.$Default>, IsBigintLiteral<any>>(true)
	testType.equal<IsBigintLiteral<unknown, IsBigintLiteral.$Default>, IsBigintLiteral<unknown>>(true)
	testType.equal<IsBigintLiteral<never, IsBigintLiteral.$Default>, IsBigintLiteral<never>>(true)
	testType.equal<IsBigintLiteral<void, IsBigintLiteral.$Default>, IsBigintLiteral<void>>(true)
	testType.equal<IsBigintLiteral<undefined, IsBigintLiteral.$Default>, IsBigintLiteral<undefined>>(true)
	testType.equal<IsBigintLiteral<null, IsBigintLiteral.$Default>, IsBigintLiteral<null>>(true)
	testType.equal<IsBigintLiteral<boolean, IsBigintLiteral.$Default>, IsBigintLiteral<boolean>>(true)
	testType.equal<IsBigintLiteral<true, IsBigintLiteral.$Default>, IsBigintLiteral<true>>(true)
	testType.equal<IsBigintLiteral<1, IsBigintLiteral.$Default>, IsBigintLiteral<1>>(true)
	testType.equal<IsBigintLiteral<number, IsBigintLiteral.$Default>, IsBigintLiteral<number>>(true)
	testType.equal<IsBigintLiteral<'a', IsBigintLiteral.$Default>, IsBigintLiteral<'a'>>(true)
	testType.equal<IsBigintLiteral<string, IsBigintLiteral.$Default>, IsBigintLiteral<string>>(true)
	testType.equal<IsBigintLiteral<symbol, IsBigintLiteral.$Default>, IsBigintLiteral<symbol>>(true)
	testType.equal<IsBigintLiteral<1n, IsBigintLiteral.$Default>, IsBigintLiteral<1n>>(true)
	testType.equal<IsBigintLiteral<{}, IsBigintLiteral.$Default>, IsBigintLiteral<{}>>(true)
	testType.equal<IsBigintLiteral<[], IsBigintLiteral.$Default>, IsBigintLiteral<[]>>(true)
	testType.equal<IsBigintLiteral<() => void, IsBigintLiteral.$Default>, IsBigintLiteral<() => void>>(true)
