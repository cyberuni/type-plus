...
it('distributes for union type', () => {
	...
	testType.equal<IsBigint<string | boolean>, false>(true)
	testType.equal<IsBigint<string | bigint>, boolean>(true)
})
...
it('can disable union distribution', () => {
	...
	testType.equal<IsBigint<bigint | 1, { distributive: false }>, false>(true)
})
...
it('works as filter', () => {
	...
	testType.equal<IsBigint<bigint, { selection: 'filter' }>, bigint>(true)
	testType.equal<IsBigint<string | bigint, { selection: 'filter' }>, bigint>(true)
})
...
it('works with unique branches', () => {
	...
	testType.equal<IsBigint<string, IsBigint.$Branch>, $Else>(true)
})
...
it('resolves `IsBigint.$Default` the same as no options', () => {
	// `IsBigint.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsBigint<any, IsBigint.$Default>, IsBigint<any>>(true)
	testType.equal<IsBigint<unknown, IsBigint.$Default>, IsBigint<unknown>>(true)
	testType.equal<IsBigint<never, IsBigint.$Default>, IsBigint<never>>(true)
	testType.equal<IsBigint<void, IsBigint.$Default>, IsBigint<void>>(true)
	testType.equal<IsBigint<undefined, IsBigint.$Default>, IsBigint<undefined>>(true)
	testType.equal<IsBigint<null, IsBigint.$Default>, IsBigint<null>>(true)
	testType.equal<IsBigint<boolean, IsBigint.$Default>, IsBigint<boolean>>(true)
	testType.equal<IsBigint<true, IsBigint.$Default>, IsBigint<true>>(true)
	testType.equal<IsBigint<1, IsBigint.$Default>, IsBigint<1>>(true)
	testType.equal<IsBigint<number, IsBigint.$Default>, IsBigint<number>>(true)
	testType.equal<IsBigint<'a', IsBigint.$Default>, IsBigint<'a'>>(true)
	testType.equal<IsBigint<string, IsBigint.$Default>, IsBigint<string>>(true)
	testType.equal<IsBigint<symbol, IsBigint.$Default>, IsBigint<symbol>>(true)
	testType.equal<IsBigint<1n, IsBigint.$Default>, IsBigint<1n>>(true)
	testType.equal<IsBigint<{}, IsBigint.$Default>, IsBigint<{}>>(true)
	testType.equal<IsBigint<[], IsBigint.$Default>, IsBigint<[]>>(true)
	testType.equal<IsBigint<() => void, IsBigint.$Default>, IsBigint<() => void>>(true)
	testType.equal<IsBigint<1 | string, IsBigint.$Default>, IsBigint<1 | string>>(true)
})
