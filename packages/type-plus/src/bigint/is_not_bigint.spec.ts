...
it('resolves `IsNotBigint.$Default` the same as no options', () => {
	// `IsNotBigint.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotBigint<any, IsNotBigint.$Default>, IsNotBigint<any>>(true)
	testType.equal<IsNotBigint<unknown, IsNotBigint.$Default>, IsNotBigint<unknown>>(true)
	testType.equal<IsNotBigint<never, IsNotBigint.$Default>, IsNotBigint<never>>(true)
	testType.equal<IsNotBigint<void, IsNotBigint.$Default>, IsNotBigint<void>>(true)
	testType.equal<IsNotBigint<undefined, IsNotBigint.$Default>, IsNotBigint<undefined>>(true)
	testType.equal<IsNotBigint<null, IsNotBigint.$Default>, IsNotBigint<null>>(true)
	testType.equal<IsNotBigint<boolean, IsNotBigint.$Default>, IsNotBigint<boolean>>(true)
	testType.equal<IsNotBigint<true, IsNotBigint.$Default>, IsNotBigint<true>>(true)
	testType.equal<IsNotBigint<1, IsNotBigint.$Default>, IsNotBigint<1>>(true)
	testType.equal<IsNotBigint<number, IsNotBigint.$Default>, IsNotBigint<number>>(true)
	testType.equal<IsNotBigint<'a', IsNotBigint.$Default>, IsNotBigint<'a'>>(true)
	testType.equal<IsNotBigint<string, IsNotBigint.$Default>, IsNotBigint<string>>(true)
	testType.equal<IsNotBigint<symbol, IsNotBigint.$Default>, IsNotBigint<symbol>>(true)
	testType.equal<IsNotBigint<1n, IsNotBigint.$Default>, IsNotBigint<1n>>(true)
	testType.equal<IsNotBigint<{}, IsNotBigint.$Default>, IsNotBigint<{}>>(true)
	testType.equal<IsNotBigint<[], IsNotBigint.$Default>, IsNotBigint<[]>>(true)
	testType.equal<IsNotBigint<() => void, IsNotBigint.$Default>, IsNotBigint<() => void>>(true)
	testType.equal<IsNotBigint<1 | string, IsNotBigint.$Default>, IsNotBigint<1 | string>>(true)
})
