...
it('resolves `IsNotObject.$Default` the same as no options', () => {
	// `IsNotObject.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotObject<any, IsNotObject.$Default>, IsNotObject<any>>(true)
	testType.equal<IsNotObject<unknown, IsNotObject.$Default>, IsNotObject<unknown>>(true)
	testType.equal<IsNotObject<never, IsNotObject.$Default>, IsNotObject<never>>(true)
	testType.equal<IsNotObject<void, IsNotObject.$Default>, IsNotObject<void>>(true)
	testType.equal<IsNotObject<undefined, IsNotObject.$Default>, IsNotObject<undefined>>(true)
	testType.equal<IsNotObject<null, IsNotObject.$Default>, IsNotObject<null>>(true)
	testType.equal<IsNotObject<boolean, IsNotObject.$Default>, IsNotObject<boolean>>(true)
	testType.equal<IsNotObject<true, IsNotObject.$Default>, IsNotObject<true>>(true)
	testType.equal<IsNotObject<1, IsNotObject.$Default>, IsNotObject<1>>(true)
	testType.equal<IsNotObject<number, IsNotObject.$Default>, IsNotObject<number>>(true)
	testType.equal<IsNotObject<'a', IsNotObject.$Default>, IsNotObject<'a'>>(true)
	testType.equal<IsNotObject<string, IsNotObject.$Default>, IsNotObject<string>>(true)
	testType.equal<IsNotObject<symbol, IsNotObject.$Default>, IsNotObject<symbol>>(true)
	testType.equal<IsNotObject<1n, IsNotObject.$Default>, IsNotObject<1n>>(true)
	testType.equal<IsNotObject<{}, IsNotObject.$Default>, IsNotObject<{}>>(true)
	testType.equal<IsNotObject<[], IsNotObject.$Default>, IsNotObject<[]>>(true)
	testType.equal<IsNotObject<() => void, IsNotObject.$Default>, IsNotObject<() => void>>(true)
	testType.equal<IsNotObject<1 | string, IsNotObject.$Default>, IsNotObject<1 | string>>(true)
})
