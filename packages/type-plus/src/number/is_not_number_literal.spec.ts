...
import { type $Else, type $Fn, type $Then, type IsNotNumberLiteral, testType } from '../index.js'
...
describe('IsNotNumberLiteral.$Fn', () => {
	it('is IsNotNumberLiteral as a type function', () => {
		testType.equal<$Fn.Apply<IsNotNumberLiteral.$Fn, number>, true>(true)
		testType.equal<$Fn.Apply<IsNotNumberLiteral.$Fn, 1>, false>(true)
	})
})

it('resolves `IsNotNumberLiteral.$Default` the same as no options', () => {
	// `IsNotNumberLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotNumberLiteral<any, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<any>>(true)
	testType.equal<IsNotNumberLiteral<unknown, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<unknown>>(true)
	testType.equal<IsNotNumberLiteral<never, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<never>>(true)
	testType.equal<IsNotNumberLiteral<void, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<void>>(true)
	testType.equal<IsNotNumberLiteral<undefined, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<undefined>>(true)
	testType.equal<IsNotNumberLiteral<null, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<null>>(true)
	testType.equal<IsNotNumberLiteral<boolean, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<boolean>>(true)
	testType.equal<IsNotNumberLiteral<true, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<true>>(true)
	testType.equal<IsNotNumberLiteral<1, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<1>>(true)
	testType.equal<IsNotNumberLiteral<number, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<number>>(true)
	testType.equal<IsNotNumberLiteral<'a', IsNotNumberLiteral.$Default>, IsNotNumberLiteral<'a'>>(true)
	testType.equal<IsNotNumberLiteral<string, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<string>>(true)
	testType.equal<IsNotNumberLiteral<symbol, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<symbol>>(true)
	testType.equal<IsNotNumberLiteral<1n, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<1n>>(true)
	testType.equal<IsNotNumberLiteral<{}, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<{}>>(true)
	testType.equal<IsNotNumberLiteral<[], IsNotNumberLiteral.$Default>, IsNotNumberLiteral<[]>>(true)
	testType.equal<IsNotNumberLiteral<() => void, IsNotNumberLiteral.$Default>, IsNotNumberLiteral<() => void>>(true)
