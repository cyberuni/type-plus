...
it('resolves `IsNotNegative.$Default` the same as no options', () => {
	// `IsNotNegative.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotNegative<any, IsNotNegative.$Default>, IsNotNegative<any>>(true)
	testType.equal<IsNotNegative<unknown, IsNotNegative.$Default>, IsNotNegative<unknown>>(true)
	testType.equal<IsNotNegative<never, IsNotNegative.$Default>, IsNotNegative<never>>(true)
	testType.equal<IsNotNegative<void, IsNotNegative.$Default>, IsNotNegative<void>>(true)
	testType.equal<IsNotNegative<undefined, IsNotNegative.$Default>, IsNotNegative<undefined>>(true)
	testType.equal<IsNotNegative<null, IsNotNegative.$Default>, IsNotNegative<null>>(true)
	testType.equal<IsNotNegative<boolean, IsNotNegative.$Default>, IsNotNegative<boolean>>(true)
	testType.equal<IsNotNegative<true, IsNotNegative.$Default>, IsNotNegative<true>>(true)
	testType.equal<IsNotNegative<1, IsNotNegative.$Default>, IsNotNegative<1>>(true)
	testType.equal<IsNotNegative<number, IsNotNegative.$Default>, IsNotNegative<number>>(true)
	testType.equal<IsNotNegative<'a', IsNotNegative.$Default>, IsNotNegative<'a'>>(true)
	testType.equal<IsNotNegative<string, IsNotNegative.$Default>, IsNotNegative<string>>(true)
	testType.equal<IsNotNegative<symbol, IsNotNegative.$Default>, IsNotNegative<symbol>>(true)
	testType.equal<IsNotNegative<1n, IsNotNegative.$Default>, IsNotNegative<1n>>(true)
	testType.equal<IsNotNegative<{}, IsNotNegative.$Default>, IsNotNegative<{}>>(true)
	testType.equal<IsNotNegative<[], IsNotNegative.$Default>, IsNotNegative<[]>>(true)
	testType.equal<IsNotNegative<() => void, IsNotNegative.$Default>, IsNotNegative<() => void>>(true)
	testType.equal<IsNotNegative<1 | string, IsNotNegative.$Default>, IsNotNegative<1 | string>>(true)
})
