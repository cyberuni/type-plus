...
import { type $Else, type $Fn, type $Then, type IsIntegerLiteral, testType } from '../index.js'
...
describe('IsIntegerLiteral.$Fn', () => {
	it('is IsIntegerLiteral as a type function', () => {
		testType.equal<$Fn.Apply<IsIntegerLiteral.$Fn, 1>, true>(true)
		testType.equal<$Fn.Apply<IsIntegerLiteral.$Fn, number>, false>(true)
	})
})

it('resolves `IsIntegerLiteral.$Default` the same as no options', () => {
	// `IsIntegerLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsIntegerLiteral<any, IsIntegerLiteral.$Default>, IsIntegerLiteral<any>>(true)
	testType.equal<IsIntegerLiteral<unknown, IsIntegerLiteral.$Default>, IsIntegerLiteral<unknown>>(true)
	testType.equal<IsIntegerLiteral<never, IsIntegerLiteral.$Default>, IsIntegerLiteral<never>>(true)
	testType.equal<IsIntegerLiteral<void, IsIntegerLiteral.$Default>, IsIntegerLiteral<void>>(true)
	testType.equal<IsIntegerLiteral<undefined, IsIntegerLiteral.$Default>, IsIntegerLiteral<undefined>>(true)
	testType.equal<IsIntegerLiteral<null, IsIntegerLiteral.$Default>, IsIntegerLiteral<null>>(true)
	testType.equal<IsIntegerLiteral<boolean, IsIntegerLiteral.$Default>, IsIntegerLiteral<boolean>>(true)
	testType.equal<IsIntegerLiteral<true, IsIntegerLiteral.$Default>, IsIntegerLiteral<true>>(true)
	testType.equal<IsIntegerLiteral<1, IsIntegerLiteral.$Default>, IsIntegerLiteral<1>>(true)
	testType.equal<IsIntegerLiteral<number, IsIntegerLiteral.$Default>, IsIntegerLiteral<number>>(true)
	testType.equal<IsIntegerLiteral<'a', IsIntegerLiteral.$Default>, IsIntegerLiteral<'a'>>(true)
	testType.equal<IsIntegerLiteral<string, IsIntegerLiteral.$Default>, IsIntegerLiteral<string>>(true)
	testType.equal<IsIntegerLiteral<symbol, IsIntegerLiteral.$Default>, IsIntegerLiteral<symbol>>(true)
	testType.equal<IsIntegerLiteral<1n, IsIntegerLiteral.$Default>, IsIntegerLiteral<1n>>(true)
	testType.equal<IsIntegerLiteral<{}, IsIntegerLiteral.$Default>, IsIntegerLiteral<{}>>(true)
	testType.equal<IsIntegerLiteral<[], IsIntegerLiteral.$Default>, IsIntegerLiteral<[]>>(true)
	testType.equal<IsIntegerLiteral<() => void, IsIntegerLiteral.$Default>, IsIntegerLiteral<() => void>>(true)
