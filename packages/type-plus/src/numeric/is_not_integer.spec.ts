...
it('resolves `IsNotInteger.$Default` the same as no options', () => {
	// `IsNotInteger.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotInteger<any, IsNotInteger.$Default>, IsNotInteger<any>>(true)
	testType.equal<IsNotInteger<unknown, IsNotInteger.$Default>, IsNotInteger<unknown>>(true)
	testType.equal<IsNotInteger<never, IsNotInteger.$Default>, IsNotInteger<never>>(true)
	testType.equal<IsNotInteger<void, IsNotInteger.$Default>, IsNotInteger<void>>(true)
	testType.equal<IsNotInteger<undefined, IsNotInteger.$Default>, IsNotInteger<undefined>>(true)
	testType.equal<IsNotInteger<null, IsNotInteger.$Default>, IsNotInteger<null>>(true)
	testType.equal<IsNotInteger<boolean, IsNotInteger.$Default>, IsNotInteger<boolean>>(true)
	testType.equal<IsNotInteger<true, IsNotInteger.$Default>, IsNotInteger<true>>(true)
	testType.equal<IsNotInteger<1, IsNotInteger.$Default>, IsNotInteger<1>>(true)
	testType.equal<IsNotInteger<number, IsNotInteger.$Default>, IsNotInteger<number>>(true)
	testType.equal<IsNotInteger<'a', IsNotInteger.$Default>, IsNotInteger<'a'>>(true)
	testType.equal<IsNotInteger<string, IsNotInteger.$Default>, IsNotInteger<string>>(true)
	testType.equal<IsNotInteger<symbol, IsNotInteger.$Default>, IsNotInteger<symbol>>(true)
	testType.equal<IsNotInteger<1n, IsNotInteger.$Default>, IsNotInteger<1n>>(true)
	testType.equal<IsNotInteger<{}, IsNotInteger.$Default>, IsNotInteger<{}>>(true)
	testType.equal<IsNotInteger<[], IsNotInteger.$Default>, IsNotInteger<[]>>(true)
	testType.equal<IsNotInteger<() => void, IsNotInteger.$Default>, IsNotInteger<() => void>>(true)
	testType.equal<IsNotInteger<1 | string, IsNotInteger.$Default>, IsNotInteger<1 | string>>(true)
})
