...
it('resolves `IsNotPositive.$Default` the same as no options', () => {
	// `IsNotPositive.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotPositive<any, IsNotPositive.$Default>, IsNotPositive<any>>(true)
	testType.equal<IsNotPositive<unknown, IsNotPositive.$Default>, IsNotPositive<unknown>>(true)
	testType.equal<IsNotPositive<never, IsNotPositive.$Default>, IsNotPositive<never>>(true)
	testType.equal<IsNotPositive<void, IsNotPositive.$Default>, IsNotPositive<void>>(true)
	testType.equal<IsNotPositive<undefined, IsNotPositive.$Default>, IsNotPositive<undefined>>(true)
	testType.equal<IsNotPositive<null, IsNotPositive.$Default>, IsNotPositive<null>>(true)
	testType.equal<IsNotPositive<boolean, IsNotPositive.$Default>, IsNotPositive<boolean>>(true)
	testType.equal<IsNotPositive<true, IsNotPositive.$Default>, IsNotPositive<true>>(true)
	testType.equal<IsNotPositive<1, IsNotPositive.$Default>, IsNotPositive<1>>(true)
	testType.equal<IsNotPositive<number, IsNotPositive.$Default>, IsNotPositive<number>>(true)
	testType.equal<IsNotPositive<'a', IsNotPositive.$Default>, IsNotPositive<'a'>>(true)
	testType.equal<IsNotPositive<string, IsNotPositive.$Default>, IsNotPositive<string>>(true)
	testType.equal<IsNotPositive<symbol, IsNotPositive.$Default>, IsNotPositive<symbol>>(true)
	testType.equal<IsNotPositive<1n, IsNotPositive.$Default>, IsNotPositive<1n>>(true)
	testType.equal<IsNotPositive<{}, IsNotPositive.$Default>, IsNotPositive<{}>>(true)
	testType.equal<IsNotPositive<[], IsNotPositive.$Default>, IsNotPositive<[]>>(true)
	testType.equal<IsNotPositive<() => void, IsNotPositive.$Default>, IsNotPositive<() => void>>(true)
	testType.equal<IsNotPositive<1 | string, IsNotPositive.$Default>, IsNotPositive<1 | string>>(true)
})
