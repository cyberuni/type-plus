...
import { type $Else, type $Fn, type $Then, type IsPositive, testType } from '../index.js'
...
describe('IsPositive.$Fn', () => {
	it('is IsPositive as a type function', () => {
		testType.equal<$Fn.Apply<IsPositive.$Fn, 1>, true>(true)
		testType.equal<$Fn.Apply<IsPositive.$Fn, -1>, false>(true)
	})
})

it('resolves `IsPositive.$Default` the same as no options', () => {
	// `IsPositive.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsPositive<any, IsPositive.$Default>, IsPositive<any>>(true)
	testType.equal<IsPositive<unknown, IsPositive.$Default>, IsPositive<unknown>>(true)
	testType.equal<IsPositive<never, IsPositive.$Default>, IsPositive<never>>(true)
	testType.equal<IsPositive<void, IsPositive.$Default>, IsPositive<void>>(true)
	testType.equal<IsPositive<undefined, IsPositive.$Default>, IsPositive<undefined>>(true)
	testType.equal<IsPositive<null, IsPositive.$Default>, IsPositive<null>>(true)
	testType.equal<IsPositive<boolean, IsPositive.$Default>, IsPositive<boolean>>(true)
	testType.equal<IsPositive<true, IsPositive.$Default>, IsPositive<true>>(true)
	testType.equal<IsPositive<1, IsPositive.$Default>, IsPositive<1>>(true)
	testType.equal<IsPositive<number, IsPositive.$Default>, IsPositive<number>>(true)
	testType.equal<IsPositive<'a', IsPositive.$Default>, IsPositive<'a'>>(true)
	testType.equal<IsPositive<string, IsPositive.$Default>, IsPositive<string>>(true)
	testType.equal<IsPositive<symbol, IsPositive.$Default>, IsPositive<symbol>>(true)
	testType.equal<IsPositive<1n, IsPositive.$Default>, IsPositive<1n>>(true)
	testType.equal<IsPositive<{}, IsPositive.$Default>, IsPositive<{}>>(true)
	testType.equal<IsPositive<[], IsPositive.$Default>, IsPositive<[]>>(true)
	testType.equal<IsPositive<() => void, IsPositive.$Default>, IsPositive<() => void>>(true)
	testType.equal<IsPositive<1 | string, IsPositive.$Default>, IsPositive<1 | string>>(true)
})
