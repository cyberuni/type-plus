...
it('resolves `IsInteger.$Default` the same as no options', () => {
	// `IsInteger.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsInteger<any, IsInteger.$Default>, IsInteger<any>>(true)
	testType.equal<IsInteger<unknown, IsInteger.$Default>, IsInteger<unknown>>(true)
	testType.equal<IsInteger<never, IsInteger.$Default>, IsInteger<never>>(true)
	testType.equal<IsInteger<void, IsInteger.$Default>, IsInteger<void>>(true)
	testType.equal<IsInteger<undefined, IsInteger.$Default>, IsInteger<undefined>>(true)
	testType.equal<IsInteger<null, IsInteger.$Default>, IsInteger<null>>(true)
	testType.equal<IsInteger<boolean, IsInteger.$Default>, IsInteger<boolean>>(true)
	testType.equal<IsInteger<true, IsInteger.$Default>, IsInteger<true>>(true)
	testType.equal<IsInteger<1, IsInteger.$Default>, IsInteger<1>>(true)
	testType.equal<IsInteger<number, IsInteger.$Default>, IsInteger<number>>(true)
	testType.equal<IsInteger<'a', IsInteger.$Default>, IsInteger<'a'>>(true)
	testType.equal<IsInteger<string, IsInteger.$Default>, IsInteger<string>>(true)
	testType.equal<IsInteger<symbol, IsInteger.$Default>, IsInteger<symbol>>(true)
	testType.equal<IsInteger<1n, IsInteger.$Default>, IsInteger<1n>>(true)
	testType.equal<IsInteger<{}, IsInteger.$Default>, IsInteger<{}>>(true)
	testType.equal<IsInteger<[], IsInteger.$Default>, IsInteger<[]>>(true)
	testType.equal<IsInteger<() => void, IsInteger.$Default>, IsInteger<() => void>>(true)
	testType.equal<IsInteger<1 | string, IsInteger.$Default>, IsInteger<1 | string>>(true)
})
