...
it('can override $void branch', () => {
	testType.equal<IsNotNever<void>, true>(true)
	testType.equal<IsNotNever<void, { $void: unknown }>, unknown>(true)
	testType.equal<IsNotNever<void, { $void: 123 }>, 123>(true)
})
...
it('resolves `IsNotNever.$Default` the same as no options', () => {
	// `IsNotNever.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotNever<any, IsNotNever.$Default>, IsNotNever<any>>(true)
	testType.equal<IsNotNever<unknown, IsNotNever.$Default>, IsNotNever<unknown>>(true)
	testType.equal<IsNotNever<never, IsNotNever.$Default>, IsNotNever<never>>(true)
	testType.equal<IsNotNever<void, IsNotNever.$Default>, IsNotNever<void>>(true)
	testType.equal<IsNotNever<undefined, IsNotNever.$Default>, IsNotNever<undefined>>(true)
	testType.equal<IsNotNever<null, IsNotNever.$Default>, IsNotNever<null>>(true)
	testType.equal<IsNotNever<boolean, IsNotNever.$Default>, IsNotNever<boolean>>(true)
	testType.equal<IsNotNever<true, IsNotNever.$Default>, IsNotNever<true>>(true)
	testType.equal<IsNotNever<1, IsNotNever.$Default>, IsNotNever<1>>(true)
	testType.equal<IsNotNever<number, IsNotNever.$Default>, IsNotNever<number>>(true)
	testType.equal<IsNotNever<'a', IsNotNever.$Default>, IsNotNever<'a'>>(true)
	testType.equal<IsNotNever<string, IsNotNever.$Default>, IsNotNever<string>>(true)
	testType.equal<IsNotNever<symbol, IsNotNever.$Default>, IsNotNever<symbol>>(true)
	testType.equal<IsNotNever<1n, IsNotNever.$Default>, IsNotNever<1n>>(true)
	testType.equal<IsNotNever<{}, IsNotNever.$Default>, IsNotNever<{}>>(true)
	testType.equal<IsNotNever<[], IsNotNever.$Default>, IsNotNever<[]>>(true)
	testType.equal<IsNotNever<() => void, IsNotNever.$Default>, IsNotNever<() => void>>(true)
	testType.equal<IsNotNever<1 | string, IsNotNever.$Default>, IsNotNever<1 | string>>(true)
})
