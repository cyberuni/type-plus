...
import { type $Else, type $Fn, type $Then, type IsNotTemplateLiteral, testType } from '../index.js'
...
describe('IsNotTemplateLiteral.$Fn', () => {
	it('is IsNotTemplateLiteral as a type function', () => {
		testType.equal<$Fn.Apply<IsNotTemplateLiteral.$Fn, 'a'>, true>(true)
