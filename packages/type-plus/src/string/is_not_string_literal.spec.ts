...
it('resolves `IsNotStringLiteral.$Default` the same as no options', () => {
	// `IsNotStringLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsNotStringLiteral<any, IsNotStringLiteral.$Default>, IsNotStringLiteral<any>>(true)
	testType.equal<IsNotStringLiteral<unknown, IsNotStringLiteral.$Default>, IsNotStringLiteral<unknown>>(true)
	testType.equal<IsNotStringLiteral<never, IsNotStringLiteral.$Default>, IsNotStringLiteral<never>>(true)
	testType.equal<IsNotStringLiteral<void, IsNotStringLiteral.$Default>, IsNotStringLiteral<void>>(true)
	testType.equal<IsNotStringLiteral<undefined, IsNotStringLiteral.$Default>, IsNotStringLiteral<undefined>>(true)
	testType.equal<IsNotStringLiteral<null, IsNotStringLiteral.$Default>, IsNotStringLiteral<null>>(true)
	testType.equal<IsNotStringLiteral<boolean, IsNotStringLiteral.$Default>, IsNotStringLiteral<boolean>>(true)
	testType.equal<IsNotStringLiteral<true, IsNotStringLiteral.$Default>, IsNotStringLiteral<true>>(true)
	testType.equal<IsNotStringLiteral<1, IsNotStringLiteral.$Default>, IsNotStringLiteral<1>>(true)
	testType.equal<IsNotStringLiteral<number, IsNotStringLiteral.$Default>, IsNotStringLiteral<number>>(true)
	testType.equal<IsNotStringLiteral<'a', IsNotStringLiteral.$Default>, IsNotStringLiteral<'a'>>(true)
	testType.equal<IsNotStringLiteral<string, IsNotStringLiteral.$Default>, IsNotStringLiteral<string>>(true)
	testType.equal<IsNotStringLiteral<symbol, IsNotStringLiteral.$Default>, IsNotStringLiteral<symbol>>(true)
	testType.equal<IsNotStringLiteral<1n, IsNotStringLiteral.$Default>, IsNotStringLiteral<1n>>(true)
	testType.equal<IsNotStringLiteral<{}, IsNotStringLiteral.$Default>, IsNotStringLiteral<{}>>(true)
	testType.equal<IsNotStringLiteral<[], IsNotStringLiteral.$Default>, IsNotStringLiteral<[]>>(true)
	testType.equal<IsNotStringLiteral<() => void, IsNotStringLiteral.$Default>, IsNotStringLiteral<() => void>>(true)
