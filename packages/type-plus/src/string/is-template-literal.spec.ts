...
it('resolves `IsTemplateLiteral.$Default` the same as no options', () => {
	// `IsTemplateLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsTemplateLiteral<any, IsTemplateLiteral.$Default>, IsTemplateLiteral<any>>(true)
	testType.equal<IsTemplateLiteral<unknown, IsTemplateLiteral.$Default>, IsTemplateLiteral<unknown>>(true)
	testType.equal<IsTemplateLiteral<never, IsTemplateLiteral.$Default>, IsTemplateLiteral<never>>(true)
	testType.equal<IsTemplateLiteral<void, IsTemplateLiteral.$Default>, IsTemplateLiteral<void>>(true)
	testType.equal<IsTemplateLiteral<undefined, IsTemplateLiteral.$Default>, IsTemplateLiteral<undefined>>(true)
	testType.equal<IsTemplateLiteral<null, IsTemplateLiteral.$Default>, IsTemplateLiteral<null>>(true)
	testType.equal<IsTemplateLiteral<boolean, IsTemplateLiteral.$Default>, IsTemplateLiteral<boolean>>(true)
	testType.equal<IsTemplateLiteral<true, IsTemplateLiteral.$Default>, IsTemplateLiteral<true>>(true)
	testType.equal<IsTemplateLiteral<1, IsTemplateLiteral.$Default>, IsTemplateLiteral<1>>(true)
	testType.equal<IsTemplateLiteral<number, IsTemplateLiteral.$Default>, IsTemplateLiteral<number>>(true)
	testType.equal<IsTemplateLiteral<'a', IsTemplateLiteral.$Default>, IsTemplateLiteral<'a'>>(true)
	testType.equal<IsTemplateLiteral<string, IsTemplateLiteral.$Default>, IsTemplateLiteral<string>>(true)
	testType.equal<IsTemplateLiteral<symbol, IsTemplateLiteral.$Default>, IsTemplateLiteral<symbol>>(true)
	testType.equal<IsTemplateLiteral<1n, IsTemplateLiteral.$Default>, IsTemplateLiteral<1n>>(true)
	testType.equal<IsTemplateLiteral<{}, IsTemplateLiteral.$Default>, IsTemplateLiteral<{}>>(true)
	testType.equal<IsTemplateLiteral<[], IsTemplateLiteral.$Default>, IsTemplateLiteral<[]>>(true)
	testType.equal<IsTemplateLiteral<() => void, IsTemplateLiteral.$Default>, IsTemplateLiteral<() => void>>(true)
