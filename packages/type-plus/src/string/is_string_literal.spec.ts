...
import { type $Else, type $Fn, type $Then, type IsStringLiteral, testType } from '../index.js'
...
describe('IsStringLiteral.$Fn', () => {
	it('is IsStringLiteral as a type function', () => {
		testType.equal<$Fn.Apply<IsStringLiteral.$Fn, 'a'>, true>(true)
		testType.equal<$Fn.Apply<IsStringLiteral.$Fn, string>, false>(true)
	})
})

it('resolves `IsStringLiteral.$Default` the same as no options', () => {
	// `IsStringLiteral.$Default` documents the default; the type never reads it, so pin the two together.
	testType.equal<IsStringLiteral<any, IsStringLiteral.$Default>, IsStringLiteral<any>>(true)
	testType.equal<IsStringLiteral<unknown, IsStringLiteral.$Default>, IsStringLiteral<unknown>>(true)
	testType.equal<IsStringLiteral<never, IsStringLiteral.$Default>, IsStringLiteral<never>>(true)
	testType.equal<IsStringLiteral<void, IsStringLiteral.$Default>, IsStringLiteral<void>>(true)
	testType.equal<IsStringLiteral<undefined, IsStringLiteral.$Default>, IsStringLiteral<undefined>>(true)
	testType.equal<IsStringLiteral<null, IsStringLiteral.$Default>, IsStringLiteral<null>>(true)
	testType.equal<IsStringLiteral<boolean, IsStringLiteral.$Default>, IsStringLiteral<boolean>>(true)
	testType.equal<IsStringLiteral<true, IsStringLiteral.$Default>, IsStringLiteral<true>>(true)
	testType.equal<IsStringLiteral<1, IsStringLiteral.$Default>, IsStringLiteral<1>>(true)
	testType.equal<IsStringLiteral<number, IsStringLiteral.$Default>, IsStringLiteral<number>>(true)
	testType.equal<IsStringLiteral<'a', IsStringLiteral.$Default>, IsStringLiteral<'a'>>(true)
	testType.equal<IsStringLiteral<string, IsStringLiteral.$Default>, IsStringLiteral<string>>(true)
	testType.equal<IsStringLiteral<symbol, IsStringLiteral.$Default>, IsStringLiteral<symbol>>(true)
	testType.equal<IsStringLiteral<1n, IsStringLiteral.$Default>, IsStringLiteral<1n>>(true)
	testType.equal<IsStringLiteral<{}, IsStringLiteral.$Default>, IsStringLiteral<{}>>(true)
	testType.equal<IsStringLiteral<[], IsStringLiteral.$Default>, IsStringLiteral<[]>>(true)
	testType.equal<IsStringLiteral<() => void, IsStringLiteral.$Default>, IsStringLiteral<() => void>>(true)
