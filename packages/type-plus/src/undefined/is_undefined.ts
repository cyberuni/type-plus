...
export namespace IsUndefined {
	 ...
	 * 🧰 *type function*
	 *
	 * `IsUndefined` as a type function, with its options `$O` applied.
	 *
	 * @example
	 * ```ts
	 * type R = $Fn.Apply<IsUndefined.$Fn, undefined> // true
	 * type R = $Fn.Apply<IsUndefined.$Fn, null> // false
	 * ```
	 */
	export interface $Fn<$O extends $StrictOptions<$O, $Options> = {}> extends $FnBase {
		readonly out: IsUndefined<this['in'], $O>
	}
